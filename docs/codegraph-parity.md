...
| Language/dialect breadth | Behind | 22 language dialects; Vue/Svelte component flows; native ArkTS grammar; bounded ArkUI component/state/event/router/style-helper/emitter, component-owned popup `@Builder`, exact same-file direct `@BuilderParam` assignments, and ohpm package flows; adversarial, incremental, live differential, and pinned real-repo gates | Objective-C, Astro, Liquid, Delphi, Luau, imported/inline/trailing-closure and transitive ArkUI builder flows, and remaining CodeGraph dialects |
