...
| Core CLI/MCP names and schemas | Compatible (core) | eight handlers, pinned contract fixture, persistent-stdio binary test, and 19-scenario live differential run against identity-verified pinned CodeGraph | pagination and cross-platform suites |
...
| Language/dialect breadth | Behind | 22 language dialects; Vue/Svelte component flows; native ArkTS grammar, bounded ArkUI component/state/event flows, adversarial fixtures, live differential checks, and pinned real-repo gates | Objective-C, Astro, Liquid, Delphi, Luau, Harmony package manifests, ArkUI router/emitter/helper flows, and remaining CodeGraph dialects |
