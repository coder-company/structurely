...
| Language/dialect breadth | Behind | 22 language dialects; Vue/Svelte component flows; native ArkTS grammar, bounded ArkUI component/state/event and ohpm package flows, adversarial fixtures, live differential checks, and pinned real-repo gates | Objective-C, Astro, Liquid, Delphi, Luau, ArkUI router/emitter/helper flows, and remaining CodeGraph dialects |
