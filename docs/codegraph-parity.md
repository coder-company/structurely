...
| Language/dialect breadth | Behind | 21 language dialects; Vue/Svelte offset-preserving embedded scripts, component identities, template children/events, and pinned real-repo gates | Objective-C, ArkTS, Astro, Liquid, Delphi, Luau, and remaining CodeGraph dialects |
