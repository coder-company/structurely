...
| Language/dialect breadth | Behind | 22 language dialects; Vue/Svelte component flows; native ArkTS grammar; bounded ArkUI component/state/event/router/style-helper/emitter, component-owned popup `@Builder`, and ohpm package flows; adversarial, incremental, live differential, and pinned real-repo gates | Objective-C, Astro, Liquid, Delphi, Luau, ArkUI `@BuilderParam` value flow, and remaining CodeGraph dialects |
